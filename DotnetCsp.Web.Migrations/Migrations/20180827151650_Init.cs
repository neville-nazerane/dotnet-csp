        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnlyFiles = table.Column<string>(maxLength: 800, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ServerPackages_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPackages_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPackages_UpdatedById",
                table: "ClientPackages",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerPackages_CreatedById",
                table: "ServerPackages",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ServerPackages_PackageId",
                table: "ServerPackages",
                column: "PackageId");
